...
public class StudentDbHelper extends SQLiteOpenHelper {
    ...
    public LinkedList<Student> readStudents(String stuNumber) {
        ...
        if(cursor.moveToFirst()) {
            do {
                int stuNameIndex = cursor.getColumnIndex("stuName");
                int stuMajorIndex = cursor.getColumnIndex("stuMajor");
                int stuPhoneIndex = cursor.getColumnIndex("stuPhone");
                int stuQqIndex = cursor.getColumnIndex("stuQq");
                int stuAddressIndex = cursor.getColumnIndex("stuAddress");



                //String stuNum = cursor.getString(cursor.getColumnIndex("stuNumber"));
                String stuName = cursor.getString(stuNameIndex);
                String stuMajor = cursor.getString(stuMajorIndex);
                String stuPhone = cursor.getString(stuPhoneIndex);
                String stuQq = cursor.getString(stuQqIndex);
                String stuAddress = cursor.getString(stuAddressIndex);

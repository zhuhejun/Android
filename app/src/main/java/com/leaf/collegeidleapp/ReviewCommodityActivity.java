...
public class ReviewCommodityActivity extends AppCompatActivity {
    ...
    TextView title,description,price,phone,collectionNum,reviewNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collectionNum=findViewById(R.id.tv_collctionNum);
        reviewNum=findViewById(R.id.tv_reviewNum);
...
//            price.setText("¥"+String.valueOf(b.getFloat("price")));
//            phone.setText(b.getString("phone"));
//            collectionNum.setText(""+b.getInt("collectionNum"));
//            reviewNum.setText(""+b.getInt("reviewNum"));
...
//        });
    ...
    public void loadData2( int commodityId) {
        ...
        description.setText(commodity.getDescription());
        price.setText("¥" + String.valueOf(commodity.getPrice()));
        phone.setText(commodity.getPhone());
        collectionNum.setText("" + commodity.getCollectionNum());
        reviewNum.setText("" + commodity.getReviewNum());
